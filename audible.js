...
class audible extends HTMLElement {
  constructor() {
    ...
    <tfoot style="padding: 0.5rem 1rem; background-color: rgba(0,0,0,.03); border-top: 1px solid rgba(0,0,0,.125);">
        ...
        <tr>
            <td>
                <button class="btn-success" type="button" id="audible-id-comenzar" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-playPause" onclick="this.playAudio();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-terminar" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-subirVol" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-bajarVol" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-callar" onclick="this.click();">
