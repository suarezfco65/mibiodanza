...
class audible extends HTMLElement {
  constructor() {
    ...
    <tfoot style="padding: 0.5rem 1rem; background-color: rgba(0,0,0,.03); border-top: 1px solid rgba(0,0,0,.125);">
        ...
        <tr>
            <td>
                <button class="btn-success" type="button" id="audible-id-comenzar" title="Reiniciar" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-playPause" title="play" onclick="this.playAudio();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-terminar" title="Finalizar" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-subirVol" title="Volumen +" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-bajarVol" title="Volumen -" onclick="this.click();">
            ...
            <td>
                <button class="btn-success" type="button" id="audible-id-callar" title="Silenciar" onclick="this.click();">
    ...
    oAudio.terminar.click = function () {
      ...
      oAudio.playPause.className = 'btn-success';
    ...
    oAudio.playPause.playAudio = function () {
      oAudio.playPause.className = 'btn-danger';
    ...
    oAudio.playPause.pauseAudio = function () {
      oAudio.playPause.className = 'btn btn-success';
